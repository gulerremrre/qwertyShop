...
<?php
        ...
        <?php
            ...
            else
            {
                ...
                echo "<h2 class='card-header'> alle producten <a href='Zoeken.php'><input type='submit' class='btn btn-primary' value='Zoek'></a> <a href='toevoegenAf.php'><input type='submit' class='btn btn-info' value='Toevoegen'></a></h2>";
