        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link active" href="../klanten/tableklanten.php"><i class="fas fa-table"></i><span>Tabel Klanten</span></a></li>
                            ...
                            <div class="row row-cols-1">
                                    <form method="get" name="searchForm" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                        ...
                                        <select class="form-select" name="searchCategory" id="searchCategory">
                                            ...
                                            <option value="klantvoornaam">Klantvoornaam</option>
                                            <option value="klantachternaam">Klantachternaam</option>
                                ...
                                <?php
                                    ...
                                    else
                                    {
                                        if(isset($_GET['zoek']))
                                        {
                                            ...
                                            $stmt->execute();
                                            $stmt->bind_result($klantnr, $voornaam,$achternaam, $telefoon, $postcode, $email, $wachtwoord, $adres);
