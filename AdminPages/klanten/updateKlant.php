...
<head>
    ...
    <?php
        ...
        $stmt->execute();
        $stmt->bind_result($klantnr, $klantvoornaam_update, $klantachternaam_update, $telefoon_update, $postcodeid_update, $email_update, $wachtwoord_update, $adres_update);
        $stmt->fetch();
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 fw-bold">Update klanten</p>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" id="klantachternaam" type="text" name="klantachternaam" value="<?php echo $klantachternaam_update; ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" id="telefoon" type="text" name="telefoon" value="<?php echo $telefoon_update; ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text" id="email" name="email" value="<?php echo $email_update; ?>">
